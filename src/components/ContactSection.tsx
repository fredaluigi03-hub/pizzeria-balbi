      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-16">
          <div className={`reveal ${headerVisible ? 'visible' : ''}`}>
            <h3 className="font-playfair text-cream text-2xl mb-8" style={{ fontFamily: "'Playfair Display', serif" }}>
              Prenotazione
            </h3>
          ...
          <div className={`reveal reveal-delay-2 ${headerVisible ? 'visible' : ''} flex flex-col gap-8`}>
            <div className="flex flex-col gap-4">
              {[
                { icon: <Phone size={16} />, label: 'Telefono', value: '+39 377 372 7225', href: 'tel:+393773727225' },
                { icon: <Instagram size={16} />, label: 'Instagram', value: '@pizzeriabalbi', href: 'https://instagram.com/pizzeriabalbi' },
                { icon: <MapPin size={16} />, label: 'Indirizzo', value: 'Via Salita Palazzo SNC, 83042 Atripalda (AV)', href: 'https://maps.google.com/?q=Pizzeria+Balbi+Atripalda' },
              ].map((item) => (
                <a
                  key={item.label}
                  href={item.href}
                ...
                >
                  ...
                  <div>
                    <p className="text-[9px] uppercase tracking-[0.3em] text-cream/40 font-geist" style={{ fontFamily: "'Geist', sans-serif" }}>
                      {item.label}
                    </p>
                    <p className="text-cream font-geist text-sm mt-0.5 group-hover:text-gold transition-colors" style={{ fontFamily: "'Geist', sans-serif" }}>
                      {item.value}
                    </p>
                  </div>
                </a>
            ...
            <div className="flex flex-wrap gap-3">
              <a
                ...
                style={{ fontFamily: "'Geist', sans-serif", background: '#25d366', color: '#fff' }}
              >
              ...
              <a href="tel:+393773727225" className="interactive btn-outline-gold flex items-center gap-2 text-xs" style={{ fontFamily: "'Geist', sans-serif" }}>
                <Phone size={13} />
                Chiama
              </a>
            </div>
